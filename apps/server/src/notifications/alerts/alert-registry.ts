...
export const ALERT_TYPES: AlertTypeDef[] = [
  ...
  // ── Cloudflare ───────────────────────────────────────────
  {
    key: 'cloudflare.tunnels_down',
    label: 'Tunnels down over threshold',
    description: 'The number of Cloudflare Tunnels that are down/degraded/inactive crossed the limit set on its page.',
    category: 'Cloudflare',
    defaultSeverity: 'warning',
    defaultEnabled: true,
    defaultChannels: ['email'],
  ...
  {
    key: 'cloudflare.zones_paused',
    label: 'Zones paused over threshold',
    description: 'The number of paused/deactivated Cloudflare zones crossed the limit set on its page.',
    category: 'Cloudflare',
    defaultSeverity: 'warning',
    defaultEnabled: true,
    defaultChannels: ['email'],
  ...
  {
    key: 'cloudflare.certs_expiring',
    label: 'Certificates expiring over threshold',
    description: 'The number of Cloudflare SSL certificates expiring soon (within ~30 days) crossed the limit set on its page.',
    category: 'Cloudflare',
    defaultSeverity: 'warning',
    defaultEnabled: true,
    defaultChannels: ['email'],
  ...
  {
    key: 'cloudflare.tokens_expiring',
    label: 'Service tokens expiring over threshold',
    description: 'The number of Cloudflare Zero Trust service tokens expiring soon (within ~14 days) crossed the limit set on its page.',
    category: 'Cloudflare',
    defaultSeverity: 'warning',
    defaultEnabled: true,
    defaultChannels: ['email'],
  ...
  {
    key: 'cloudflare.threats',
    label: 'Threats over threshold',
    description: 'The number of threats Cloudflare mitigated in the last 24h crossed the limit set on its page.',
    category: 'Cloudflare',
    defaultSeverity: 'info',
    defaultEnabled: true,
    defaultChannels: ['email'],
